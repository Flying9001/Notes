...
#### 5.1 JRebel and XRebel for IntelliJ  

jrebel 是一款 java 热部署插件,功能强大,开发必备,唯一不好，收费太贵  

- 安装:  

File --- Settings --- Plugins --- Browse respositories --- 搜索「JRebel」 --- 选择「JRebel and XRebel for IntelliJ」  
...
File --- Settings --- Plugins --- Browse respositories --- 搜索「actBPM」 --- 选择「actBPM」安装即可 
